...
Item {
    ...
    Rectangle {
        ...
        Pane {
            ...
            TextEdit {
                text: "Write or paste the line 'auth    sufficient pam_exec.so quiet /usr/local/bin/elan_auth' on top in /etc/pam.d/gdm-password using 'nano /etc/pam.d/gdm-password' to use the integrated file in your gdm login manager. You can also paste this into /etc/pam.d/sudo on top to use fingerprint sensor in the terminal. ThankYou!"
