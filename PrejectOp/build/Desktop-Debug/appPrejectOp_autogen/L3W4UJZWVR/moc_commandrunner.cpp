...
#include "../../../../scripts/commandrunner.h"
...
template <> constexpr inline auto CommandRunner::qt_create_metaobjectdata<qt_meta_tag_ZN13CommandRunnerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Method 'runPrivileged'
        QtMocHelpers::MethodData<void(const QString &)>(6, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::QString, 7 },
        }}),
    };
...
void CommandRunner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->commandFinished((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->runPrivileged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 3: _t->runPrivileged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CommandRunner::*)()>(_a, &CommandRunner::commandStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CommandRunner::*)(bool , int )>(_a, &CommandRunner::commandFinished, 1))
            return;
    }
}
...
// SIGNAL 0
void CommandRunner::commandStarted()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CommandRunner::commandFinished(bool _t1, int _t2)
{
